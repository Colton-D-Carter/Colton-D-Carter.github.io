...
const apiURL = "https://api.openweathermap.org/data/2.5/weather?lat=42.0516&lon=-111.2535&appid=fdd4ae86db7db8e70269504861cc299b"
...
fetch(apiURL) 
    ...
    .then((jsonObject) => {
        ...
        document.getElementById('high').textContent = z + '&#8457';
        document.getElementById('humidity').textContent = jsonObject.main.humidity;  
    });

const api7day = "https://api.openweathermap.org/data/2.5/onecall?lat=42.0516&lon=-111.2535&exclude=minutely,hourly,current&appid=55301fa1a5b3fe4a3c34d2eb4ab01fd5"
